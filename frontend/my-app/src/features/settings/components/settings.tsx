...
export default function Settings() {
  ...
  return (
    <>
            ...
            <div className="flex justify-between p-3">
              ...
              <div>
                <Button
                  ...
                  className={`bg-gray-300 rounded-md p-1  items-center hover:bg-gray-500 hidden md:flex  `}
                >
                ...
                <div className="md:hidden">
                  ...
                  onClick={()=>setopenButtomSheet(true)}
                    className={`bg-gray-400 rounded-md p-1  items-center flex `}
                  >
                    <Edit2Icon className="w-3 h-3 text-gray-900" />
                    editar
                  </Button>
      ...
      {
        openButtomSheet &&(
          <BottomSheet open={openButtomSheet} onClose={()=> setopenButtomSheet(false)} >
